...
export default function Header({setShowLogin}) {
  ...
  return (
    <div className="relative w-[100vw] h-full font-IBMSans md:h-full lg:h-[100vh]">
      ...
      <div className=" w-[90vw] mx-auto pt-7 px-4 sm:px-6  lg:px-8 relative z-20 lg:h-100">
        <Navbar setShowLogin={setShowLogin}  />
        {/* { showLogin ? <LoginPopup setShowLogin={setShowLogin} /> : <></> } */}
        <div className="mx-auto my-auto pt-20 pb-20 flex flex-col items-center  md:w-[100%] lg:mt-[20vh]">
          ...
          <p
            className="text-white text-2xl text-center font-light md:text-3xl 
          ...
          <div className="mt-10 w-100 flex flex-col gap-3 justify-center text-2xl">
